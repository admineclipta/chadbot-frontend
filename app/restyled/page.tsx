...
import { MessageCircle, Users, Contact, Bot, Settings, Send, Search, Filter, ChevronDown, Plus, TrendingUp, Clock, CheckCheck, Sparkles, ArrowLeft } from "lucide-react"
import Sidebar from "@/components/sidebar-restyled"
import ConversationList from "@/components/conversation-list-restyled"
import ConversationFilters from "@/components/conversation-filters"
import ChatView, { type ChatViewRef } from "@/components/chat-view-restyled"
...
export default function RestyledPage() {
  ...
  useEffect(() => {
    const fetchConversations = async () => {
      if (!isAuthenticated || currentView !== "conversations") return
    ...
    fetchConversations()
  }, [isAuthenticated, currentView, currentPage, selectedStatusFilter, selectedChannel, searchTerm])
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 flex overflow-hidden">
        ...
        <div className="w-72 bg-white border-r border-slate-200 flex flex-col shadow-lg">
          ...
          <div className="p-4 border-b border-slate-200">
            <button 
              onClick={() => router.push("/")}
              className="w-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
            >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {currentView === "profile" && user && (
            <div className="p-8">
              ...
              <p className="text-slate-600 mt-2">Vista de perfil en desarrollo</p>
            </div>
          )}
