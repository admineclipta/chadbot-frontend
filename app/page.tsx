            ...
            {!isMobile && !selectedConversation && (
              <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/20 to-slate-50">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Selecciona una conversación</h3>
                  <p className="text-slate-600">Elige una conversación de la lista para comenzar a chatear</p>
                </div>
              </div>
            )}
          </div>
