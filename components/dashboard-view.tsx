        ...
        {recentConversations.length === 0 ? (
          ...
          <div className="space-y-3">
            {recentConversations.map((conv) => (
              <ConversationActivityItem key={conv.id} conversation={conv} />
            ))}
          </div>
        )}
      </Card>
...
function ConversationActivityItem({
  ...
  return (
    <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors cursor-pointer">
